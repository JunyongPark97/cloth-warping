...
class GMMModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        visual_names_A = ['real_image_mask', 'input_mask', 'warped_cloth']
    ...
    def backward_G(self):
        self.loss_L1 = self.criterionL1(self.warped_cloth, self.image_mask)
    ...
    def backward_D(self):
        ...
        self.loss_D = self.loss_D_1 + self.loss_D_2
